...
def test_sequence_send_daily_cap_and_reply_stop(tmp_path):
    ...
    # Frozen clocks must sit AFTER the real timestamps written at draft
    # creation, or nothing is "due" and the test silently expires with the
    # calendar. Anchor to the real clock instead of a hardcoded date.
